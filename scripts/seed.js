/**
 * Project 25 CMS Seed Script
 * 
 * Usage: npm run seed
 * Or: npx strapi run seed
 */
...
const events = [
  {
    ...
    hamperValue: "$50",
    paymentMethods: [
      { name: "PayPal", details: "project25zim@gmail.com" },
      { name: "Cash App / Venmo", details: "missnyarr" },
      { name: "EcoCash / Cash", details: "Maxine\n+263 772 352 266" }
    ],
    publishedAt: new Date().toISOString()
  },
  {
    ...
    paymentMethods: [
      { name: "PayPal", details: "project25zim@gmail.com" },
      { name: "Cash App/Venmo", details: "Nyaradzo Sirewu\n@missnyarr" },
      { name: "EcoCash/InnBucks/Cash", details: "Maxine Chisweto\n+263 772 325 566" },
      { name: "EcoCash/InnBucks/Cash", details: "Ruvarashe Dahwa\n+263 773 824 952" }
    ],
    publishedAt: new Date().toISOString()
  }
];
...
const teamMembers = [
  { name: "Mutsa Chiromo", slug: "mutsa-chiromo", occupation: "Medical Student", imageUrl: teamImageUrl('Chiromo, Mutsa 2025.jpg'), isFounder: true, order: 1 },
  { name: "Maakwe Cumanzala", slug: "maakwe-cumanzala", occupation: "PhD candidate in Economics and Public Policy", imageUrl: teamImageUrl('IMG-20250106-WA0019.jpg'), isFounder: true, order: 2 },
  { name: "Varaidzo Kamhunga", slug: "varaidzo-kamhunga", occupation: "Head of Corporate Services", imageUrl: teamImageUrl('IMG-20250113-WA0001.jpg'), isFounder: true, order: 3 },
  { name: "Ruvarashe Dahwa", slug: "ruvarashe-dahwa", occupation: "General Practioner", imageUrl: teamImageUrl('IMG-20250113-WA0002.jpg'), isFounder: true, order: 4 },
  { name: "Maxine Chisweto", slug: "maxine-chisweto", occupation: "Lawyer", imageUrl: teamImageUrl('IMG-20250113-WA0003.jpg'), isFounder: true, order: 5 },
  { name: "Mufaro Hungwe", slug: "mufaro-hungwe", occupation: "Footwear Product Developer", imageUrl: teamImageUrl('IMG-20250113-WA0004.jpg'), isFounder: true, order: 6 },
  { name: "Michelle Kabaira", slug: "michelle-kabaira", occupation: "Process Support Engineer", imageUrl: teamImageUrl('IMG-20250113-WA0005.jpg'), isFounder: true, order: 7 },
  { name: "Nyaradzo Sirewu", slug: "nyaradzo-sirewu", occupation: "Public Health Practitioner", imageUrl: teamImageUrl('IMG-20250113-WA0006.jpg'), isFounder: true, order: 8 }
];

const partners = [
  { name: "Maxitreats", slug: "maxitreats", logoUrl: "/assets/maxitreats-logo.jpg", isActive: true, order: 1 },
  { name: "New Marlborough Private Hospital", slug: "new-marlborough-private-hospital", logoUrl: "/assets/new-marlborough-private-hospital-logo.jpg", isActive: true, order: 2 },
  { name: "Australian Embassy - Zimbabwe", slug: "australian-embassy-zimbabwe", logoUrl: "/assets/australian-embassy.png", isActive: true, order: 3 },
  { name: "Chozen Foundation", slug: "chozen-foundation", logoUrl: "/assets/chozen-foundation.png", isActive: true, order: 4 },
  { name: "Tiyamike Phiri", slug: "tiyamike-phiri", logoUrl: "/assets/tiyamike-phiri-logo.jpg", isActive: true, order: 5 },
  { name: "Steel Centre", slug: "steel-centre", logoUrl: "/assets/steel-centre-logo.jpg", isActive: true, order: 6 },
  { name: "Paper Pieces", slug: "paper-pieces", logoUrl: "/assets/paper-pieces-logo.jpg", isActive: true, order: 7 },
  { name: "Arundel School", slug: "arundel-school", logoUrl: "/assets/arundel-logo.png", isActive: true, order: 8 },
  { name: "Rotaract Club of Harare City", slug: "rotaract-club-harare-city", logoUrl: "/assets/rotaract-club.svg", isActive: true, order: 9 }
];

const impactStats = [
  { amount: "500+", label: "Food hampers distributed", subtext: "Through #FeedZim campaign", order: 1 },
  { amount: "$15,000", label: "Raised for school construction", subtext: "Half the school building completed", order: 2 },
  { amount: "400", label: "Students supported", subtext: "With books, stationery & food", order: 3 }
];
...
const navigation = {
  ...
  menuItems: [
    ...
    { label: "Our Initiatives", url: "/ourinitiatives", order: 3 },
...
const pages = [
  { title: "Home", slug: "home", heroHeading: "Growing and Grounded", heroTagline: "Empowering communities and transforming lives across Zimbabwe.", heroImage: p25ImageUrl('fullsizeoutput_bce3.jpeg') },
  { title: "About Us", slug: "about", subtitle: "Our Story", content: "Established in 2020, Project 25 aims to be an initiative that reflects both our personal growth and our commitment to giving back to the communities that shaped us." },
  { title: "Volunteer", slug: "volunteer", heroHeading: "Join Our Mission", heroTagline: "Become a volunteer and help us bring positive change." },
  { title: "Donate", slug: "donate", heroHeading: "Support Our Cause", heroTagline: "Your donation makes a real difference in the lives of others." }
];
...
module.exports = async ({ strapi }) => {
  ...
  try {
    ...
    for (const initiative of initiatives) {
      await strapi.documents('api::initiative.initiative').create({ data: initiative });
    }
    ...
    for (const event of events) {
      await strapi.documents('api::event.event').create({ data: event });
    }
    ...
    for (const partner of partners) {
      await strapi.documents('api::partner.partner').create({ data: partner });
    }
    ...
    for (const stat of impactStats) {
      await strapi.documents('api::impact-stat.impact-stat').create({ data: stat });
    }
    console.log(`✅ Created ${impactStats.length} impact stats`);

    // Seed Footer (Single Type)
    console.log('📦 Seeding footer...');
    await strapi.documents('api::footer.footer').create({ data: footer });
    console.log('✅ Created footer');

    // Seed Navigation (Single Type)
    console.log('📦 Seeding navigation...');
    await strapi.documents('api::navigation.navigation').create({ data: navigation });
