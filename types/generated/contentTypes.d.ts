...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Footer content including company info, social links, and quick links';
    displayName: 'Footer';
    pluralName: 'footers';
    singularName: 'footer';
  };
  ...
  attributes: {
    companyDescription: Schema.Attribute.RichText & Schema.Attribute.Required;
    companyName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Project 25'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    developerName: Schema.Attribute.String & Schema.Attribute.Required;
    developerUrl: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickLinks: Schema.Attribute.Component<'footer.quick-link', true>;
    socialLinks: Schema.Attribute.Component<'footer.social-link', true>;
    trustName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Project 25 Trust'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiInitiativeInitiative extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project initiatives (Open Tribe Foundation, Vaka Dzidzo, FeedZim)';
  ...
  attributes: {
    breakdown: Schema.Attribute.Component<'initiative.breakdown-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fullDescription: Schema.Attribute.RichText & Schema.Attribute.Required;
    images: Schema.Attribute.Media<'images', true>;
    imageTransitionTime: Schema.Attribute.Integer;
    ...
    > &
      Schema.Attribute.Private;
    nextGoal: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    raised: Schema.Attribute.Decimal;
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoHighlight: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages (Home, About, Volunteer, Donate, etc.)';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
